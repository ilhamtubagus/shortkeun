...
func TestSendHTMLMail(t *testing.T) {
	LoadEnv("../.env")
	body := email.RegistrationMailBody{UserAgent: "Firefox on Desktop", IP: "12.23.12", DateTime: "Friday, Sep 3, 2021 9:27:56 AM (WIB)", Code: "12332", ExpireAt: "Friday, Sep 3, 2021 9:50:56 AM (WIB)"}
